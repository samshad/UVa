...
int main(){
    ...
    while(ss(a) != EOF){
        ...
        FOR(l, 0, len){
            if(a[l] == 'B' || a[l] == 'F' || a[l] == 'P' || a[l] == 'V'){
                if(l == 0)
                    pi(1);

                else{
                    if(a[l-1] != 'B' && a[l-1] != 'F' && a[l-1] != 'P' && a[l-1] != 'V')
                        pi(1);
                }
            }

            else if(a[l] == 'C' || a[l] == 'G' || a[l] == 'J' || a[l] == 'K' || a[l] == 'Q' || a[l] == 'X' || a[l] == 'S' || a[l] == 'Z'){
                if(l == 0)
                    pi(2);

                else{
                    if(a[l-1] != 'C' && a[l-1] != 'G' && a[l-1] != 'J' && a[l-1] != 'K' && a[l-1] != 'Q' && a[l-1] != 'X' && a[l-1] != 'S' && a[l-1] != 'Z')
                        pi(2);
                }
            }
